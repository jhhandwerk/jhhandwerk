...
"自身が能動的に考え行動します",
"新し事にチャレンジし変化を創造します",
"良い情報も、悪い情報も共有し組織改善に繋げます"]
const yomiList = [
"jishinnganoudoutekinikanngaekoudoushimasu", 
"atarashikotonicyarennjishihennkawosouzoushimasu",
"yoijyouhoumowaruijyouhoumokyouyushisoshikikaizennitsunagemasu"]
const englishList = []
const sentenceList = []
